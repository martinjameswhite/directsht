...
class LogNormalMocks:
    def __init__(self, Npnt, nside=2048, clg=None, verbose=False,
        ...
        :param clg: 1D numpy array. Angular power spectrum of the lognormal field.
        :param verbose: bool. Whether to print out information about the catalog
        :param alpha: float. Power law index of the angular power spectrum
        :param lmax: int. Maximum ell for the angular power spectrum
        :param ell0: float. The ell at which the angular power spectrum is normalized
